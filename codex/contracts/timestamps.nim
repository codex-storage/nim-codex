...
func `'StorageDuration`*(value: string): StorageDuration =
  StorageDuration(value: parse(value, StUint[40]))

func `'StorageTimestamp`*(value: string): StorageTimestamp =
  StorageTimestamp(value: parse(value, StUint[40]))
