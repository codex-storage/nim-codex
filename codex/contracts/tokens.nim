...
func `'TokensPerSecond`*(value: string): TokensPerSecond =
  TokensPerSecond(value: parse(value, StUint[96]))

func `'Tokens`*(value: string): Tokens =
  Tokens(value: parse(value, UInt128))
